...
export function Hero({ heroImage, cafeName = 'Premium Café', tagline }: HeroProps) {
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      {/* Content */}
      <div ref={ref} className="relative z-10 max-w-5xl mx-auto px-4 text-center text-white">
        <motion.div
        ...
        >
          ...
          >
            ...
            <Link
              href="#about"
              className="px-8 py-4 rounded-full border-2 border-white/30 text-white font-medium hover:bg-white/10 transition-all duration-300"
            >
              {t('hero.explore')}
            </Link>
          </motion.div>
      ...
      {/* Decorative Elements */}
      <div className="absolute top-1/4 left-10 w-32 h-32 bg-amber-500/10 rounded-full blur-3xl" />
      <div className="absolute bottom-1/4 right-10 w-48 h-48 bg-yellow-500/10 rounded-full blur-3xl" />
    </section>
  )
}
